                        ...
                        <div class="layui-card-body">
                            <div class="layui-row layui-col-space10 layui-form-item">
                                ...
                                <div class="layui-col-lg12">
                                    ...
                                    <div class="layui-input-block">
                                        <input type="text" name="operation_id" style="width: 50%" v-model="where.operation_id" placeholder="请输入运营中心id" class="layui-input">
                                    </div>
                                </div>
                                <?php endif;?>
                                ...
                                <div class="layui-col-lg12">
                                    ...
                                    <div class="layui-input-block">
                                        <input type="text" name="manager_id" style="width: 50%" v-model="where.manager_id" placeholder="请输入运营中心id" class="layui-input">
                                    </div>
                                </div>
                                <?php endif;?>
                                <div class="layui-col-lg12">
