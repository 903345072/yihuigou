                            ...
                            <div class="layui-tab-item layui-show">
                                <div class="layui-row layui-col-space15">
                                    ...
                                    <div class="layui-col-xs12 layui-col-sm12 layui-col-md12">
                                        <div class="grid-demo grid-demo-bg1">
                                            <div class="layui-form-item">
                                                ...
                                                <div class="layui-input-block">
                                                    <input type="text" name="intergral" lay-verify="title" autocomplete="off"
                                                           placeholder="填写此栏后商品为积分商品" class="layui-input" v-model="formData.intergral" maxlength="100">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="layui-col-xs12 layui-col-sm12 layui-col-md12">
                                        <div class="grid-demo grid-demo-bg1">
                                            <div class="layui-form-item">
                                                <label class="layui-form-label">几人团</label>
                                                <div class="layui-input-block">
                                                    <input type="text" name="intergral" lay-verify="title" autocomplete="off"
                                                           placeholder="" class="layui-input" v-model="formData.tuan_number" maxlength="100">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="layui-col-xs12 layui-col-sm12 layui-col-md12">
                                        <div class="grid-demo grid-demo-bg1">
                                            <div class="layui-form-item">
                                                ...
                                                <div class="layui-input-block">
                                                    <input type="text" name="intergral" lay-verify="title" autocomplete="off"
                                                           placeholder="拼团失败返佣比例" class="layui-input" v-model="formData.back_rate" maxlength="100">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                that.$nextTick(function () {
                    ...
                    layui.config({
                        ...
                        selectM({
                            ...
                            ,delimiter: ','
                            //候选项数据的键名
                            ,field: {idName:'value',titleName:'label',statusName:'disableda'}
                        });
                    });
                })
            },
