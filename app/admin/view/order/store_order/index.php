...
<div class="layui-fluid">
 ...
 <script type="text/html" id="lucky_number">
                        {{d.lucky_number}}
                    </script>
                     <script type="text/html" id="back_money">
                        {{d.back_money}}
                    </script>
...
<script>
    layList.tableList('List', "{:Url('order_list',['real_name'=>$real_name,'operation_id'=>$operation_id,'manager_id'=>$manager_id])}", function () {
        return [
            ...
            {field: 'lucky_number', title: '幸运数字', width: '7%', sort: true, align: 'center',templet: '#lucky_number'},
            {field: 'back_money', title: '返佣', width: '5%', sort: true, align: 'center',templet: '#back_money'},
