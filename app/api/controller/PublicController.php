...
class PublicController
{
    ...
    public function index(Request $request)
    {
        ...
        $likeInfo = StoreProduct::getHotProduct('id,image,store_name,cate_id,price,ot_price,unit_name,back_rate,tuan_number', 100);//TODO 热门榜单 猜你喜欢
        $integralInfo = StoreProduct::getIntegralPoduct('id,image,intergral,store_name', 100);//TODO 热门榜单 猜你喜欢
        ...
        return app('json')->successful(compact('banner', 'menus', 'roll', 'info', 'activity', 'lovely', 'benefit', 'likeInfo', 'logoUrl', 'couponList', 'site_name', 'subscribe', 'newGoodsBananr', 'tengxun_map_key', 'explosive_money','integralInfo'));
    }
