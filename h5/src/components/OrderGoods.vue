    ...
    <div class="goodWrapper">
      ...
      >
        ...
        <div class="text">
          ...
          <div v-if="cart.productInfo.is_intergral_pro == 0" class="money font-color-red">￥{{ cart.truePrice }}</div>
          <div v-if="cart.productInfo.is_intergral_pro == 1" class="money font-color-red">{{ cart.productInfo.intergral}}积分</div>
