import { cancelOrder, takeOrder, delOrder, payOrder, takeGoods_, takeChargeIntegral_,returnGoods_ } from "@api/order";
...
export function takeGoods(orderId) {
  return new Promise((resolve, reject) => {
...
export function returnGoodsHandler(orderId) {
  return new Promise((resolve, reject) => {

    dialog.confirm({
      mes: "确认退货?",
      opts() {
        returnGoods_(orderId)
            .then(res => {
              resolve(res);
            })
            .catch(err => {
...
export function takeChargeIntegral(orderId) {
  return new Promise((resolve, reject) => {
    dialog.confirm({

      mes: "确认兑换积分?",
      opts() {
        takeChargeIntegral_(orderId)
            .then(res => {
              resolve(res);
            })
            .catch(err => {
